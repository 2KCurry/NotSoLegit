...
local Library = Module.Functions.HttpGet("https://raw.githubusercontent.com/2KCurry/NotSoLegit/main/newuilib.lua")
...
MovementSection:AddToggle('Fake Speed Glitch (Q)', false, function(state)
    Settings.Speed.Glitch = state
end)
...
if settings.Speed.Glitch.Enabled then
